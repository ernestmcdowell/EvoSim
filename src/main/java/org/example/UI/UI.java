...
//import org.example.window.KeyListener;
//import org.example.window.MouseListener;
...
//            }
    ...
    private void startFrame(final float deltaTime) {
        ...
        float[] winWidth = {windowManager.getWidth()};
        float[] winHeight = {windowManager.getHeight()};
        double[] mousePosX = {0};
        double[] mousePosY = {0};
